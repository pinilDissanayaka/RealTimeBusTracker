...
source.addEventListener('message', function (e) {
    ...
    if (checkpoints.has(obj.bus_id)) {
        ...
        current_chechpoint.set(obj.bus_id, newMarker);
        ...
        current_chechpoint.set(obj.bus_id, marker);
    }
}, false);
...
function filterMap(){
    ...
    if(filter_button){
        var filter_query=filter_button.value.trim();
        console.log(filter_query);
    }
    else{
        filter_button.textContent="Filter";
    }
